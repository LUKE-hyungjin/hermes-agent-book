...
> 이 장은 공식 환경 변수 문서 전체를 그대로 옮긴 완전 레퍼런스라기보다, 실제로 자주 만지는 핵심 변수를 추려 정리한 요약본입니다.
...
특히 `HERMES_HOME`은 Hermes 홈 디렉터리를 바꾸는 용도입니다. 여러 설치를 분리할 때 유용하지만, 세부 런타임 동작은 버전과 플랫폼에 따라 달라질 수 있으니 실제 환경에서는 공식 레퍼런스를 함께 보는 편이 안전합니다.
...
**이전:** [← 32. CLI 레퍼런스](#32-cli-reference)
**다음:** [34. FAQ와 문제 해결 →](#34-faq)
