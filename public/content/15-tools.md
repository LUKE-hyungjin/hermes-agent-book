...
0.6.0 기준으로는 검색/추출 계층에서도 선택지가 더 넓어졌습니다. 기존 DuckDuckGo, Firecrawl 계열 외에 Exa 검색 백엔드도 추가되어, 웹 검색 품질이나 운영 방식을 다르게 가져갈 수 있습니다.
...
| Automation | `cronjob` | 예약 실행과 자동화 작업 |
