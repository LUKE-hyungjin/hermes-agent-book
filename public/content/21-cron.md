...
주의할 점은 다음과 같습니다. CLI에서도 `hermes cron list`, `pause`, `resume`, `run`, `remove`, `status`, `tick` 같은 전체 수명주기 명령을 사용할 수 있습니다.
...
**이전:** [← 20. 기타 메시징 플랫폼](#20-other-messaging)
**다음:** [22. 이벤트 훅 →](#22-hooks)
